...
import { templateApi, CreateTemplateData } from "@/lib/api";
  ...
  const createTemplateMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Template baru telah ditambahkan ke sistem",
      });
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600 mt-2">
              Buat template SPK untuk mempermudah pengguna
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="flex items-center gap-2"
          >
            {createTemplateMutation.isPending ? "Menyimpan..." : "Simpan Template"}
          </Button>
        </div>
      </div>
    </div>
